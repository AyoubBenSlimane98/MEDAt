...
const CardDoc = ({ photo, name, specialty, onClick }) => {
  ...
  return (
    <>
      <div className='w-[90%] sm:max-w-sm bg-light-color border border-gray-300 rounded-lg  shadow-xl  hover:bg-gray-200 hover:shadow-none duration-300'>
        <img
        ...
        <div className='p-5'>
          <Link to={`/doctor/${nameDoctor}`}>
            <h5 className='mb-2 text-2xl  text-nowrap md:text-2xl font-bold tracking-tight text- hover:underline text-second-color duration-200'>
              {name}
            </h5>
          </Link>
